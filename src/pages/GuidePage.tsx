    ...
    <main className="flex flex-1 flex-col px-4 pb-8 pt-6">
      ...
      <article className="space-y-8">
        ...
        <Section id="features" title="できること">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              釣った魚種数と釣果数の合計、魚種ごとの尾数や最大サイズを、記録から自動で集計します。魚種名や別名で検索できます。
            </li>
            <li>
        ...
        <Section id="mypage" title="マイページ">
          <p>
            画面下の「図鑑」タブがマイ魚種図鑑です。これまでに残した記録を魚種ごとに集計します。先頭に魚種数と釣果数の合計が出ます。魚種名や別名で検索できます。尾数や最大サイズで並べ替えられます。魚種を選ぶと、その魚の記録だけを時系列で見られます。タックル帳、単位、アカウント設定は、その右の「マイ」タブから開きます。
          </p>
          <EncyclopediaScreenMock />
          <p>
