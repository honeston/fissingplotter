    ...
    <main className="flex flex-1 flex-col px-4 pb-8 pt-6">
      ...
      <article className="space-y-8">
        ...
        <Section id="history" title="履歴と地図">
          ...
          <HistoryScreenMock />
          <p>
            一覧のカードを開くと、写真、魚種、サイズ、天気、潮位、タックル、座標を確認できます。クラウドに繋がっていて位置がある記録では、その日の潮位グラフ（釣れた時刻と満潮・干潮）も出ます。位置や魚種の打ち間違いがあればここで直し、不要な記録は削除できます。地図タイルは国土地理院の標準地図です。日本国内の記録を想定しています。
          </p>
        </Section>
