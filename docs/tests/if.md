...
対象: `buildSpeciesStats` / `pickCoverRecord` / `encyclopediaTotals`。[SCR-12](../screens/if.md#scr-12-マイ魚種図鑑)
...
| ID | 優先 | 操作 | 期待 |
|----|------|------|------|
| E2E-11a | P2 | ログイン相当で `/` | COM-01（マイページ + ログイン中）と COM-02（記録 / 履歴 / マイ図鑑）。記録タブアクティブ |
